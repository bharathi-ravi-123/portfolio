            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                >
                    ...
                    <div className="flex justify-center space-x-6 mb-12">
                        ...
                        <a href="https://www.linkedin.com/in/bharathi-r-99a400b30s596" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-primary dark:text-gray-400 dark:hover:text-accent transition-transform hover:scale-110">
                            <Linkedin size={32} />
                        </a>
